...
public class SimilarityFinderTest {
    ...
    public void returnValueOneWhenSequencesAreEmpty() {
        ...
        finder = new SimilarityFinder(new MockSequenceSearcher(expectedElements));
    ...
    public void returnValueZeroWhenOneSequenceIsEmptyAndAnotherIsSomething() {
        boolean[] expectedElements = {false};
        int[] seq1 = new int[1];
        seq1[0]=1;
        int[] seq2 = new int[0];
    ...
    public void returnValueZeroWhenSequencesAreDifferent() {
        boolean[] expectedElements = {false, false};
        int[] seq1 = new int[1];
        seq1[0]=2;
        int[] seq2 = new int[1];
        seq2[0]=3;
    ...
    public void SequencesHasManyElementsAndOnlyOneElementIsTheSame() {
        boolean[] expectedElements = {false, false, true, false, false};
        int[] seq1 = new int[3];
        seq1[0]=1;
        seq1[1]=3;
        seq1[2]=5;
